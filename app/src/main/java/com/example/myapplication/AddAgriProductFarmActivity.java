...
public class AddAgriProductFarmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_agri_product_farm);
        try{
    ...
    public void storeImageFarmProduct(View view){
        try {
            ...
            {
                databaseHandler.storeImageFarmProduct(new AddRawMaterialDetails(imageDetailsET.getText().toString(),price.getText().toString(),quantity.getText().toString(),imageTostore));
            }else{
